...
import logoChemiq from "@/assets/img/logochemiq.png";
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-4">
              <div className="relative">
                <img
                  src={logoChemiq || "https://via.placeholder.com/150x150"}
                  alt="Logo"
                  className="w-[6vh] h-18 rounded-xl shadow-lg"
                />
              ...
              <div className="relative group">
                ...
                <img
                  ...
                  className={`transition-all duration-500 ease-out rounded-xl shadow-lg ${
                    scrolled ? "w-[6vh] h-18" : "w-[6vh] h-18"
                  ...
                  <NavigationMenuList className="space-x-2">
                    <NavigationMenuItem>
                      <NavigationMenuTrigger
                        ...
                        onMouseOver={(e) => {
                          e.currentTarget.style.backgroundColor = theme.colors
                            .Primary
                      ...
                      <NavigationMenuContent>
                        <div
                          ...
                          style={{
                            backgroundColor: `${
                              theme.colors.Background || "#fff8f0"
                            }F5`,
                          }}
                        >
                              ...
                              <div className="lg:col-span-1">
                                <NavigationMenuLink asChild>
                                  <a
                                    ...
                                    onFocus={(e) => {
                                      e.currentTarget.style.boxShadow = theme
                                        .colors.Primary
                                        ? `0 0 0 3px ${theme.colors.Primary}55`
                                        : "0 0 0 3px #fc500055";
                                    }}
                                  ...
                                  >
                                    ...
                                    <div className="relative z-10">
                                      ...
                                      <p className="text-sm leading-tight text-white/90 line-clamp-3">
                                        {projects[0].informacion.substring(
                                          0,
                                          120
                                        )}
                                        ...
                    ...
                    {[
                      ...
                      <NavigationMenuItem key={index}>
                        <a
                          ...
                          onFocus={(e) => {
                            e.currentTarget.style.boxShadow = theme.colors
                              .Primary
                              ? `0 0 0 2px ${theme.colors.Primary}55`
                              : "0 0 0 2px #fc500055";
                            e.currentTarget.style.backgroundColor = theme.colors
                ...
                <div className="pt-4 border-t border-white/10">
                  ...
                  <div className="pl-4 space-y-2">
                    {projects.length > 0 ? (
                      ...
                      <p className="px-4 py-2 text-white/60 text-sm">
                        No hay proyectos disponibles
                      </p>
                    )}
                  </div>
