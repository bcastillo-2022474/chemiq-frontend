  ...
  return (
    <div className="p-8 overflow-auto">
      ...
      <div className="mb-6 flex items-center space-x-4">
        ...
        <button onClick={handleCreatePodcast} className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
          Crear Podcast
        </button>
      </div>
                ...
                <tr key={pod.id} className="border-b last:border-b-0">
                  ...
                  <td className="py-4">
                    {editingId === pod.id ? (
                      ...
                      <>
                        <button onClick={() => setEditingId(pod.id)} className="text-blue-600 hover:text-blue-800 mr-4">
                          Editar
                        </button>
                        <button onClick={() => handleDeletePodcast(pod.id)} className="text-red-600 hover:text-red-800">
                          Eliminar
                        </button>
                      </>
                    )}
