...
import type { YouTubeVideo } from "@/types/dto";
              ...
              <>
                ...
                <div className="p-6 md:w-3/5 flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <div
                      className="bg-[#1d896e] text-white px-3 py-1 rounded-full group-hover:bg-blue-700 transition-colors duration-300 flex items-center">
      ...
      {selectedVideo && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
          <div className="relative bg-white p-4 rounded-lg max-w-4xl w-full">
            <div className="absolute top-2 right-2 p-2 cursor-pointer bg-red-500 text-white rounded-full"
