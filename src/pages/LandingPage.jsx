    ...
    return (
        <div className="flex flex-col min-h-screen bg-white ">
            ...
            <main className="flex-1">
                ...
                <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-tertiary">
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
                            ...
                            <Carousel>
                                <CarouselContent>
                                    <CarouselItem><img src="https://designthinking.gal/wp-content/uploads/2015/04/trabajo_en_equipo.jpg" style={{ width: '1400px', height: '600px' }} /></CarouselItem>
                                    <CarouselItem><img src="https://designthinking.gal/wp-content/uploads/2015/04/trabajo_en_equipo.jpg" style={{ width: '1400px', height: '600px' }} /></CarouselItem>
                                    <CarouselItem><img src="https://designthinking.gal/wp-content/uploads/2015/04/trabajo_en_equipo.jpg" style={{ width: '1400px', height: '600px' }} /></CarouselItem>
                                </CarouselContent>
                                <CarouselPrevious />
