...
import {
  AtomIcon, BookOpenIcon, UsersIcon, Facebook, Twitter, Linkedin, Instagram, Mail, Phone, MapPin
} from "lucide-react"
import {
  NavigationMenu,
...
const Input = ({ placeholder, type = "text", onChange, value }) => (<input
  type={type}
  onChange={onChange}
...
const images = ["https://res.cloudinary.com/uvggt/image/upload/f_auto/v1619631396/2021/Abril/Biodi%C3%A9sel/Biodiesel-1.jpg", "https://res.cloudinary.com/uvggt/image/upload/f_auto/v1707843136/2024/02%20Febrero/Premio%20ILAN/Premio-ILAN-Portada.jpg", "https://res.cloudinary.com/webuvg/image/upload/f_auto,q_auto,w_329,c_scale,fl_lossy,dpr_2.63/v1602887269/WEB/Academico/Carreras/Ingenieria/Quimica/laboratorio-ing-quimica.jpg", "https://res.cloudinary.com/uvggt/image/upload/f_auto/v1657039547/2022/Julio/Foro%20Desarrollo%20industrial%20verde/Ingenieria-Quimica-UVG-1.jpg", "https://res.cloudinary.com/uvggt/image/upload/f_auto/v1649106331/2022/Abril/Bodi%C3%A9sel-Puma/Biodiesel-1.jpg"]
      ...
      >
        <div className="container px-4 md:px-6 mx-auto">
          {loading ? (<>
            ...
            <h2
              className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 text-accent">
      ...
      <section id="about" className="w-full bg-tertiary">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center w-full">
          ...
          <div
            ...
            style={{ padding: "100px" }}
          >
            {loading ? (<TextSectionSkeleton lines={5}/>) : (<>
          ...
          <div className="w-full">
            {!imagesLoaded ? (<CarouselSkeleton/>) : (<AutoCarousel images={images}/>)}
          </div>
        </div>
      </section>
    ...
    <footer className="w-full py-12 bg-base text-white">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {loading ? (// Footer skeletons con diseño mejorado
            Array(4)
              .fill(0)
              .map((_, i) => (<div key={i} className="space-y-4">
                <div
                  className="h-6 w-[180px] bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 rounded relative overflow-hidden">
                  <div
                    className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-gray-500/30 to-transparent"/>
                </div>
                <div
                  className="h-4 w-full bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 rounded relative overflow-hidden">
                  <div
                    className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-gray-500/30 to-transparent"/>
                </div>
                <div
                ...
                <div
                  className="h-4 w-3/4 bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 rounded relative overflow-hidden">
                  <div
                    className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-gray-500/30 to-transparent"/>
                </div>
              </div>))) : (<>
  ...
  return (
    ...
    >
      <div className="container px-4 md:px-6 mx-auto">
        ...
        />) : (<>
          <h2
            className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-4 text-accent">
