              ...
              <div className="flex-shrink-0 flex items-center">
                {loading ? (
                  ...
                  <span className="text-2xl font-bold text-white ">
                    <img src="./src/assets/img/ChemiqLogoNav.png" className="w-full h-[50px]" />
                  </span>
                )}
              </div>
                          ...
                          <li className="row-span-3 ">
                            <NavigationMenuLink asChild>
                              <a
                                ...
                                href="/"
                              >
                                <div className="mt-4 text-lg font-medium text-white">BioDiesel</div>
                                <p className="text-sm leading-tight text-white/90">
                                  La producción de biodiésel: una alternativa viable de reciclaje y una oportunidad de
                                  aprendizaje
                                </p>
                              </a>
                            </NavigationMenuLink>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <p className="mx-auto max-w-[700px] text-base md:text-xl">
                      La Asociación de Química es una comunidad dedicada a la promoción del estudio, la investigación y
                      la difusión de la química en todas sus ramas. Nos enfocamos en impulsar el conocimiento
                      científico, fomentando el intercambio de ideas y la colaboración entre estudiantes y profesionales
                      del área.
                    </p>
                  </>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-base">
                      Fomentamos la investigación avanzada y la innovación en diversas áreas del conocimiento, brindando
                      a nuestros estudiantes universitarios el acceso a recursos y herramientas para desarrollar
                      proyectos.
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-base">
                      Proveemos una amplia gama de recursos educativos diseñados para mejorar la experiencia de
                      aprendizaje de nuestros estudiantes universitarios. Desde materiales didácticos hasta plataformas
                      interactivas.
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-base">
                      Creamos espacios de conexión entre estudiantes, profesionales y académicos, donde nuestros
                      estudiantes pueden expandir su red de contactos. Fomentamos la colaboración y el intercambio de
                      ideas.
                    </p>
                  </div>
                </div>
              ...
              {loading ? (
                ...
                <>
                  ...
                  <p className="text-base md:text-xl">
                    La Asociación de Becados nació con el propósito de dar respuesta a la necesidad de apoyo en el
                    ámbito educativo. Sabemos que la educación es la llave para cambiar vidas, y estamos convencidos de
                    que cada estudiante tiene un potencial único. Nuestra misión es brindar recursos y una red de apoyo
                    a estudiantes que se comprometen con su educación y desean transformar su futuro.
                  </p>
            ...
            {loading ? (
              ...
              <>
                ...
                <p className="text-center text-base mb-8 max-w-md mx-auto">
                  Si tienes alguna duda o comentario, no dudes en enviarnos un mensaje. Nos encanta escuchar tus
                  sugerencias y ayudarte con lo que necesites.
                </p>
              </>
            )}
            ...
            {loading ? (
              ...
              <>
                <div>
                  ...
                  <p className="text-sm">
                    La Asociación de Química es una comunidad dedicada a la promoción del estudio, la investigación y la
                    difusión de la química en todas sus ramas.
                  </p>
                </div>
                <div>
